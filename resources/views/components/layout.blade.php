...
<html lang="en">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-body-tertiary">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav justify-content-center flex-grow-1">
                <li class="nav-item">
                    <a class="nav-link mx-4" href="/">Homepage</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link mx-4" href="/articles">Lista Articoli</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link mx-4" href="/contact">Contattami</a>
                </li>
            </ul>
  ...
  <div class="container bg-success py-4">
  {{$slot}}
  </div>
  ...
  <footer class="text-center text-lg-start bg-body-tertiary text-muted">
    ...
    <div class="text-center p-4" style="background-color: rgba(0, 0, 0, 0.05);">
      © 2021 Copyright:
      <a class="text-reset fw-bold" href="https://mdbootstrap.com/">Jader Daniotti</a>
    </div>
  </footer>
